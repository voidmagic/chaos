...
class ShallowDecoderModel(TransformerModel):

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return ShallowDecoder(args, tgt_dict, embed_tokens)
...
class ShallowDecoder(TransformerDecoder):
    ...
    def extract_features_scriptable(
        ...
        encoder_out_state = torch.stack([t[0] for t in encoder_out.encoder_states], dim=0)
...
@register_model_architecture("shallow", "shallow_iwslt")
